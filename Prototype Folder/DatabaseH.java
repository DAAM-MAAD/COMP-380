...
public class JDBC {
    ...
    /**
     * Sets command to enable mySQL to remove safety protocols to delete entire tables
     * @throws SQLException
     */
    ...
    /**
     * SQL command to delete all rows from rooms SQL table
     * @throws SQLException
     */
    ...
    /**
     * SQL command to delete all rows from accounts SQL table
     * @throws SQLException
     */
    ...
    /**
     * SQL command to delete all rows from reservations SQL table
     * @throws SQLException
     */
